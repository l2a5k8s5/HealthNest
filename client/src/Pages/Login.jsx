...
//                 <span className="px-2 bg-white text-gray-500">New to Makhana?</span>
//               </div>
//             </div>
//           </div>
...
import { toast } from 'react-toastify';
import { FiMail, FiLock, FiEye, FiEyeOff } from 'react-icons/fi';
// import heroImage from '../assets/login-people.png'; // put your image here
        ...
        <div className="px-8 py-10 md:px-10 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-2.5 rounded-lg bg-[#ff6b35] text-white text-sm font-semibold shadow-md hover:bg-[#ff5c2a] transition flex items-center justify-center"
            >
            ...
            <div className="flex items-center my-2">
              ...
              <span className="px-2 text-[11px] text-gray-400 uppercase tracking-wide">
                Or Login with
              </span>
              <div className="flex-grow h-px bg-gray-200" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="flex items-center justify-center border border-gray-200 rounded-lg py-2 text-xs font-semibold text-gray-700 bg-white hover:bg-gray-50"
              >
                <img
              ...
              >
                <img
                  src="https://www.svgrepo.com/show/502629/facebook-fill.svg"
                  alt="Facebook"
                  className="w-4 h-4 mr-2"
                />
                Facebook
